  ...
  <PublicLayout>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      ...
      <nav class="flex items-center space-x-2 text-sm mb-6">
        ...
        <span class="text-gray-900 font-semibold">{{ rack.name }}</span>
      </nav>

      <!-- Hero Header -->
      <div class="relative mb-10 p-8 bg-gradient-to-br from-amber-600 via-orange-600 to-rose-600 rounded-3xl shadow-xl overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          >
            ...
            <span class="text-sm font-medium">Kembali ke Rak</span>
          </Link>
          ...
          <div class="flex items-start justify-between flex-wrap gap-4">
            <div class="flex-1">
              <div class="flex items-center space-x-3 mb-3">
                ...
                <div>
                  <p class="text-amber-100 text-sm font-medium">{{ cabinet.name }} / {{ rack.name }}</p>
                  <h1 class="text-4xl font-bold text-white">Koleksi Buku</h1>
                </div>
              </div>
              <p class="text-amber-100 text-lg max-w-2xl">Jelajahi koleksi buku yang tersimpan rapi di rak ini. Klik untuk melihat detail lengkap setiap buku.</p>
            </div>
  ...
  >
    ...
    <div class="mt-4 px-1 flex flex-col" style="min-height: 88px;">
      ...
      <div v-if="!filteredBooks || filteredBooks.length === 0" class="text-center py-20 bg-gradient-to-br from-gray-50 to-amber-50 rounded-3xl border-2 border-dashed border-gray-300">
        ...
        <h3 v-if="activeSearch" class="text-2xl font-bold text-gray-900 mb-3">Tidak Ada Hasil</h3>
        <h3 v-else class="text-2xl font-bold text-gray-900 mb-3">Belum Ada Buku</h3>
        <p v-if="activeSearch" class="text-gray-600 text-lg max-w-md mx-auto mb-6">
          Tidak ditemukan buku dengan kata kunci <span class="font-semibold text-amber-600">"{{ activeSearch }}"</span>. Coba kata kunci lain.
        </p>
        <p v-else class="text-gray-600 text-lg max-w-md mx-auto mb-6">Rak <span class="font-semibold text-amber-600">{{ rack.name }}</span> masih kosong. Tambahkan buku untuk mulai membangun koleksi Anda.</p>
        <button
          v-if="activeSearch"
          @click="handleClear"
          class="inline-flex items-center px-6 py-3 bg-gradient-to-r from-amber-600 to-rose-600 text-white font-semibold rounded-lg shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-300"
        >
