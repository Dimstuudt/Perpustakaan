  ...
  Swal.fire({
    ...
    html: `
      <div class="text-left space-y-2">
        ...
        <div><strong>Fee:</strong> Rp ${props.book.fee.toLocaleString('id-ID')}</div>
  ...
  <AppLayout :breadcrumbs="breadcrumbs">
    ...
    <div class="p-6 bg-gray-50 min-h-screen">
      <div class="max-w-4xl mx-auto">
              ...
              <div class="flex-shrink-0">
                <div class="relative">
                  ...
                  <div
                    ...
                    class="absolute inset-0 bg-gradient-to-br from-gray-100 to-gray-200 rounded-lg flex items-center justify-center"
                  >
              ...
              <div class="flex-1 min-w-0">
                <div class="space-y-4">
                  ...
                  <div class="space-y-2">
                    ...
                    <div v-if="props.book.publisher" class="flex items-center text-gray-600">
                      <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div v-if="props.book.year" class="flex items-center text-gray-600">
                      <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <div v-if="props.book.category" class="flex items-center text-gray-600">
                      <svg class="w-5 h-5 mr-2 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 pt-4 border-t border-gray-200">
                    <div class="flex items-center">
                      ...
                      <p class="text-xl font-semibold text-gray-900">
                        Fee: <span class="text-emerald-600">Rp {{ props.book.fee.toLocaleString('id-ID') }}</span>
                      </p>
                    </div>
        ...
        <!-- Warning Alert -->
        <div class="bg-amber-50 border border-amber-200 rounded-lg p-4 mb-8 shadow-sm">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6 mb-8">
          <div class="flex flex-col sm:flex-row gap-4 justify-between items-center">
            <Button
              ...
              class="w-full sm:w-auto px-6 py-3 bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold rounded-lg shadow-sm transition duration-200"
              @click="goBack"
            />
            <Button
              ...
              class="w-full sm:w-auto px-8 py-3 bg-blue-600 hover:bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:shadow-lg transition duration-200"
              @click="pinjam"
            />
            <div v-else-if="props.hasPendingLoan" class="text-center sm:text-left">
              <p class="text-sm text-gray-600">Anda memiliki peminjaman pending. Selesaikan dulu.</p>
            </div>
            <Tag
              v-else
              value="Stok Habis"
        ...
        <!-- Book Description -->
        <div v-if="props.book.description" class="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
          <div class="p-6 lg:p-8">
            <div class="flex items-center mb-4">
              ...
              <h2 class="text-xl font-semibold text-gray-900">Deskripsi Buku</h2>
            </div>
        ...
        <div v-else class="bg-white rounded-xl shadow-sm border border-gray-200 p-8 text-center">
          ...
          <h3 class="text-lg font-semibold text-gray-900 mb-2">Deskripsi Tidak Tersedia</h3>
          <p class="text-gray-500">Informasi deskripsi buku belum ditambahkan.</p>
        </div>
      </div>
    </div>
  </AppLayout>
